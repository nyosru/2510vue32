            ...
            <div v-else>
                ...
                <div class="flex flex-col w-full max-w-[400px]">
                    <div
                        ...
                        :key="booking.id"
                        class="flex justify-between items-center border-b py-2 flex-row"
                    >
                        <div>
...
import { useBookingStore } from "@/stores/bookingStore" // ✅ подключаем store

const store = useBookingStore() // ✅ инициализируем store
...
async function deleteBooking(id) {
    ...
    try {
        ...
        console.log('📢 вызываем triggerReload()')
        store.triggerReload() // должно вызвать обновление
    } catch (e) {
...
// Обновляем при смене даты или услуги
